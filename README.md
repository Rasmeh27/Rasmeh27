...
<section class="social-media">
  ...
  <section class="skills">
    <h2>💻 Skills</h2>
    <p align="center">
      <img src="https://skillicons.dev/icons?i=html,css,js,python,java,cs,react,mysql,postgres,spring,visualstudio,vscode,notion,idea,postman,git,github,figma,electron,dotnet,bootstrap,insomnia" alt="Programming Skills">
    </p>
